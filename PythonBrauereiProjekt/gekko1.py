...
m = GEKKO()
tf = 40
m.time = np.linspace(0,tf,2*tf+1) # Array erzeugen mit 81 stellen
step = np.zeros(2*tf+1) # Erzeugt Array mit 81 0en
step[3:40] = 2.0 # Beschreibt Array step von 3 zu 40 mit 2.0
step[40:]  = 5.0 # Beschreibt Array step von 40 bis Ende mit 5.0
