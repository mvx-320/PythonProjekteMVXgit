...
class Ui_NeueRastHinzufuegen(object):
    def setupUi(self, NeueRastHinzufuegen):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Icons/Feuer1200x1200.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.typCoB.addItem(icon1, "")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Icons/snowflake1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.typCoB.addItem(icon2, "")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Icons/clock1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.typCoB.addItem(icon3, "")
    ...
    def retranslateUi(self, NeueRastHinzufuegen):
        ...
        self.typCoB.setItemText(0, _translate("NeueRastHinzufuegen", "wärmer"))
        self.typCoB.setItemText(1, _translate("NeueRastHinzufuegen", "kälter"))
        self.typCoB.setItemText(2, _translate("NeueRastHinzufuegen", "egal"))
